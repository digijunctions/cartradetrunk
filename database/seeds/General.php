        ...
        public function run()
        {
            ...
            DB::table('core_settings')->insert(
                [
                    ...
                    [
                        'name'  => 'admin_email',
                        'val'   => 'contact@domain-name.com',
                        'group' => "general",
                    ], [
                        'name'  => 'email_from_name',
                        'val'   => 'Car Trade Value pvt. ltd.',
                        'group' => "general",
                    ], [
...
<a href="mailto:contact@domain-name.com">contact@domain-name.com</a>',
                        'group' => "general",
                    ],
                    [
                        'name'  => 'footer_text_left',
                        'val'   => 'Copyright © 2019 by Car Trade Value pvt. ltd.',
                        'group' => "general",
                    ],
                    [
                    ...
                    [
                        ...
                        'val' => "<!DOCTYPE html><html><head></head><body><h3>Car Trade Value pvt. ltd.</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                        'group' => "general",
                    ],
                    [
			...
			[
				...
				[
					'name'  => "email_header",
					'val'   => '<h1 class="site-title" style="text-align: center">Car Trade Value pvt. ltd.</h1>',
					'group' => "general",
				],
				[
					'name'  => "email_footer",
					'val'   => '<p class="" style="text-align: center">&copy; 2019 Car Trade Value pvt. ltd.. All rights reserved</p>',
					'group' => "general",
				],
				[
				...
				[
					...
					'val'   => '<h1 style="text-align: center">Welcome!</h1>
						...
						<p>Thank you for signing up with Car Trade Value pvt. ltd.! We hope you enjoy your time with us.</p>
						<p>Regards,</p>
						<p>Car Trade Value pvt. ltd.</p>',
					'group' => "user",
				],
				[
